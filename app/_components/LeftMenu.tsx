      ...
      <li className="nav-item">
        ...
        <div className="collapse">
          <div className="bg-white py-2 collapse-inner rounded">
            ...
            <Link className="collapse-item" href="/products">
              제품 목록
            </Link>
      ...
      <li className="nav-item">
        ...
        <div className="collapse">
          <div className="bg-white py-2 collapse-inner rounded">
            ...
            <Link className="collapse-item" href="/items">
              상품 목록
            </Link>
      ...
      <li className="nav-item">
        ...
        <div className="collapse">
          <div className="bg-white py-2 collapse-inner rounded">
            ...
            <Link className="collapse-item" href="/makers">
              제조사 목록
            </Link>
            <Link className="collapse-item" href="utilities-border.html">
              제조사 등록
      ...
      <li className="nav-item">
        ...
        <div className="collapse">
          <div className="bg-white py-2 collapse-inner rounded">
            ...
            <Link className="collapse-item" href="/category">
              카테고리 목록
            </Link>
            <Link className="collapse-item" href="utilities-border.html">
              카테고리 등록
